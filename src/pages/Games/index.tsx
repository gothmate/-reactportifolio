...
export default function Games() {
    ...
    const gameItems: Ititle[] = [
			...
			{
				id: 7,
				linkGit: 'https://gothmate.github.io/hangman_game/',
				img: '/hangman.jpg',
				title: 'Hangman Game',
				description: 'The classic hangman game written in JavaScript vanilla.',
				repository: 'https://github.com/gothmate/hangman_game',
				figma: '',
				alt: 'hangman game',
			},
			{
